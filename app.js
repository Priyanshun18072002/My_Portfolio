...
var typed = new Typed(".content-desc", {
    strings: ["Aspiring Software Engineer", "Full Stack Java Developer", "AI/ML Enthusiast","Delhi Regional Showcase Winner '24","DSA Enthusiast"],
    typeSpeed: 100,
    backSpeed: 50,
    loop: true
});
...
const myDetails = {
    fullname: "Piyush jaiswal",
    photo: "https://media.licdn.com/dms/image/C4D03AQG3FrOvJcpHag/profile-displayphoto-shrink_800_800/0/1655345562984?e=1712793600&v=beta&t=UzzK4yg9PhcVPoc0d8bM58OJyyvJTXYQRZsg0lbVzBM"
}
const colors = [
    ["red", "#de3b51"],
    ["yellow", "#f0ed4d"],
...
const myselfDetails = [
    'A <span class="gold">Web Developer</span> based in India',
    'A Mastered advanced machine learning via <span class="gold">Nvidia GRILL</span>, Global Infoventures training.',
    'Skilled in developing websites using <span class="gold">multiple</span> technologies ',
    '<span class="gold">Winner of Delhi regional</span> Techsaksham-Microsoft showcase, acclaimed for innovation, collaboration.',
    'CodeChef 3*, HackerRank 4*, solved<span class="gold"> 450+ DSA</span>  on multiple platforms.',
    // 'Hobbyist Desktop App Developer with <span class="gold">Python and Java</span>',
    'Fascinated with the <span class="gold">JavaScript</span> ecosystem'
]

myselfDiv.appendChild(
    node("div", {cl: "myself-container"}, [
        node("div", {cl: "myself-photo"}, [
            node("img", {cl: "myself-img", src: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740643605/Priyanshu_Nigam_ynwji1.jpg", alt: "my pmmmhoto", width: 128}),
        ]),
...
// Array of image URLs you want to cycle through
const imageURLs = [
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740643605/Priyanshu_Nigam_ynwji1.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740649613/xrn49rnmwmfacpljnpue.jpg" ,
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740651847/iwp2jug8n8oe0w6w9pw5.png",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740651950/bfi3w33p9r3evf4yij6n.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740652831/lkl5czywjn8xgkw9uktg.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740651525/ssjpnuc1a0cchylwr06o.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740651356/itxwvkezlg9t9bmp98si.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740652027/bwmgnrhanvvbmkkxbcb2.jpg",
    "https://res.cloudinary.com/dide1vkhw/image/upload/v1740652520/vkuw2qletc4bi4pf0phv.jpg"
  ];
  
  // Set initial index
  let currentIndex = 0;
  
  // Select the image element created earlier in the About section
  const myselfImg = document.querySelector('.myself-img');
  
  // Change the image every 5 seconds (5000ms)
  setInterval(() => {
    currentIndex = (currentIndex + 1) % imageURLs.length;
    myselfImg.src = imageURLs[currentIndex];
  }, 5000);
...
const skillsInfo = {
    ...
    know: {
        ...
        langs: [
            ...
            { icon: "https://logospng.org/download/javascript/logo-javascript-icon-512.png", name: "JavaScript", perc: 75, url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript" },
            // { icon: "./resources/skills/cs.png", name: "C#", perc: 65, url: "https://learn.microsoft.com/en-us/dotnet/csharp/tour-of-csharp/" },
            { icon: "https://cdn3.iconfinder.com/data/icons/logos-and-brands-adobe/512/181_Java-1024.png", name: "Java", perc: 50, url: "https://www.java.com/en/download/help/whatis_java.html" }
        ],
        skills: [
            [
                { icon: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740687461/iflkpivso1xawnexkk4f.png", name: "C", url: "https://cplusplus.com/" },
                { icon: "https://clipground.com/images/html5-png-image-10.png", name: "HTML", url: "https://developer.mozilla.org/en-US/docs/Web/HTML" },
                { icon: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740686046/evwpbl6uuczixpgfmvxg.png", name: "CSS", url: "https://developer.mozilla.org/en-US/docs/Web/CSS" },
                { icon: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740686930/xwzmmn0dpnoodvhkjazz.png", name: "C++", url: "https://cplusplus.com/" },
                
                // { icon: "./resources/skills/mongodb.png", name: "MongoDB", url: "https://www.mongodb.com/" },
                { icon: "https://www.freeiconspng.com/uploads/sql-server-icon-png-29.png", name: "SQL", url: "https://en.wikipedia.org/wiki/SQL" },
                { icon: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740687111/uo7uqzfatx0zjtqxzrxv.png", name: "Git", url: "https://git-scm.com/" },
                { icon: "https://code.visualstudio.com/assets/images/code-stable.png", name:"Visual Studio Code" ,url:"https://code.visualstudio.com/"},
    ...
    touch: {
        ...
        skills: [
            ...
            { icon: "https://www.pngrepo.com/png/374146/180/typescript-official.png", name: "TypeScript" },
            { icon:"https://res.cloudinary.com/dide1vkhw/image/upload/v1740687225/iivhxgvzvx0lnehud2uu.png" ,name:"SpringBoot" ,url:"https://angular.io/"},
            ...
            { icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/ChatGPT_logo.svg/1024px-ChatGPT_logo.svg.png", name: "ChatGPT", url:"https://openai.com/blog/better-language-models/"},
            // { icon: "./resources/skills/wordpress.png", name:"WordPress" ,url:"https://wordpress.org/"},
            { icon:"https://brandlogos.net/wp-content/uploads/2021/09/bootstrap-logo.png" ,name:"Bootstrap" ,url:"https://getbootstrap.com/"},
            ...
            { icon: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740687625/xny7edoqmit8cai8ruyu.png", name: "Docker", url: "https://www.docker.com/" },
...
const projects = [
    {
        title: "SMARTBANK",
        descr: " Developed SmartBank, a secure and scalable online banking system using Java, MySQL, OOPS, and Apache Server Pages. Implemented core banking features like account creation, transactions, and fund transfers with PIN-based security and encryption. Automated processes to enhance efficiency, reducing transaction time for users and administrators.",
        image: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740640424/h9qyx91gqagw9uqnijak.jpg",
       
        github: "https://github.com/Priyanshun18072002/Bank_-Management_system",
        techstack: ["Java", "MySQL", "OOPS", "Apache Server Pages", "AWT", "Swing"],
        disabled: false
    },
    {
        title: "AyurMeds",
        descr: "Developed a predictive medicine recommendation system using Ayurvedic texts for personalized health insights. Implemented a decision tree model for accuracy. Built a full-stack solution with HTML, CSS, SQLite, and MySQL, ensuring efficient data management and predictive analytics for optimized personalized health recommendations.",
        image: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740652993/q5bwhocgkveguspe9n0k.jpg",
        github: "https://github.com/Priyanshun18072002/Ayurmeds",
        techstack: ["Python", "Django", "SQLite", "MySQL", "HTML", "CSS", "Decision Tree", "Predictive Analytics"],
    ...
    },
    {
        ...
        descr: "Developed a Computer Vision model using Roboflow to detect PPE violations in real-time. Trained YOLOv7 on a custom dataset for accurate helmet and vest detection. Improved accuracy with data augmentation, ensuring reliable safety compliance monitoring in construction sites and traffic for helmet enforcement.",
        image: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740640179/nnmcitodn3kublzwcten.webp",
        github: "https://github.com/Priyanshun18072002/PPE_DETECTION",
        techstack: ["Roboflow", "YOLOv7", "Computer Vision", "Deep Learning", "Data Augmentation"],
        disabled: false
    },
    {
        ...
        image: "https://res.cloudinary.com/dide1vkhw/image/upload/v1740681790/tspu7f6zmajnxjjshwmf.jpg",
        github: "https://github.com/Priyanshun18072002/My_Portfolio",
                ...
                node("div", { cl: "project-details" }, [
                    ...
                    node("div", { cl: "project-buttons" }, [
                        node("a", { cl: "project-button left", href: project.github, target: "_blank" }, [
                            node("img", { src: "https://tse2.mm.bing.net/th?id=OIP.PlTtFbnNh3xSI_Xs9kV53wHaHP&pid=Api&P=0&h=180"}),
...
//     {
//         name: 'GitHub',
//         link: "https://github.com/prince-132",
...
//     {
//         name: 'Leetcode',
//         link: "https://leetcode.com/Gyanendra_23/",
//         svg: ``
//     },
//     {
//         name: 'Hackerrank',
//         link: "https://www.hackerrank.com/profile/gyanendranathsh1",
//         svg: ``
//     }
// ]
...
const contactLinks = [
    {
        name: 'Email',
        link: "mailto:gyanendranathshukla4035@gmail.com",
        svg: ``
    },
    {
        name: 'LinkedIn',
        link: "https://www.linkedin.com/in/gyanendra-sde/",
    ...
    {
        name: "Instagram",
        link: "https://www.instagram.com/mr_princeshukla/",
